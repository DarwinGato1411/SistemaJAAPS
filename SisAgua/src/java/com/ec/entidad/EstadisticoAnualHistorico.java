 ...
 */
@Entity
@Table(name = "estadistico_anual_historico")
public class EstadisticoAnualHistorico implements Serializable {
    ...
    public EstadisticoAnualHistorico() {
    }

    public EstadisticoAnualHistorico(String rubro, Date fechaInicio, Date fechaFin, BigDecimal saldoAnterior, BigDecimal totalIngreso, BigDecimal recaudo, BigDecimal saldoActual) {
        this.rubro = rubro;
    ...
    public EstadisticoAnualHistorico(Integer idEstadistico) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EstadisticoAnualHistorico)) {
            return false;
        }
        EstadisticoAnualHistorico other = (EstadisticoAnualHistorico) object;

...
public class Parametrizar implements Serializable {
    ...
    @Column(name = "par_multa_corte")
    private BigDecimal parMultaCorte;
    ...
    public BigDecimal getParMultaCorte() {
        return parMultaCorte;
    }

    public void setParMultaCorte(BigDecimal parMultaCorte) {
        this.parMultaCorte = parMultaCorte;
    }

    public BigDecimal getParMultaPorcentaje() {
        return parMultaPorcentaje;
    }

    public void setParMultaPorcentaje(BigDecimal parMultaPorcentaje) {
        this.parMultaPorcentaje = parMultaPorcentaje;
    }

 ...
 */
@Entity
@Table(name = "estadistico_mensual_historico")
public class EstadisticoMensualHistorico implements Serializable {
    ...
    public EstadisticoMensualHistorico() {
    }

    public EstadisticoMensualHistorico(String rubro, Date fechaInicio, Date fechaFin, BigDecimal saldoAnterior, BigDecimal totalIngreso, BigDecimal recaudo, BigDecimal saldoActual) {
        this.rubro = rubro;
    ...
    public EstadisticoMensualHistorico(Integer idEstadistico) {
    ...
    public Boolean getMostrar() {
        ...
        if (rubro.equals("MULTA POR 2 MESES IMPAGOS")) {
            mostrar = Boolean.TRUE;
        } else if (rubro.equals("INTERES VALORES IMPAGOS")) {
            mostrar = Boolean.TRUE;
        } else {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EstadisticoMensualHistorico)) {
            return false;
        }
        EstadisticoMensualHistorico other = (EstadisticoMensualHistorico) object;

 ...
 */
@Entity
@Table(name = "estadistico_diario_historico")
public class EstadisticoDiarioHistorico implements Serializable {
    ...
    public EstadisticoDiarioHistorico() {
    }

    public EstadisticoDiarioHistorico(Integer idEstadistico) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EstadisticoDiarioHistorico)) {
            return false;
        }
        EstadisticoDiarioHistorico other = (EstadisticoDiarioHistorico) object;
